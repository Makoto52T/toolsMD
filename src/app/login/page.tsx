  ...
  return (
    <div className="flex min-h-screen items-center justify-center" style={{ background: 'var(--bg)' }}>
      <div className="text-center">
        ...
        <p className="mb-8" style={{ color: 'var(--muted)' }}>Diagram to Markdown — plan your system visually</p>
        <button
          onClick={() => signIn('google', { callbackUrl: '/' })}
          className="px-8 py-3 rounded-lg font-medium text-white flex items-center gap-3 mx-auto"
